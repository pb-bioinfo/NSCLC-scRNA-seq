...
f5a
ggsave(filename = "f5a.tiff", plot = f5a, width = 10, height = 3, units = "in")
...
combined_plot
ggsave(filename = "f5b.tiff", plot = combined_plot, width = 6, height = 4.5, units = "in")
...
ggsave(filename = "f5c.tiff", plot = f5c, width = 4.5, height = 9, units = "in")
...
ggsave(filename = "f5d.tiff", plot = f5d, width = 6, height = 3, units = "in")
...
ggsave(filename = "f5e.tiff", plot = f5e, width = 6, height = 3, units = "in")
...
metadata2<- sce_score@meta.data[,c("R_T_N","stage2", "cytotoxic_score1","exhausted_score1")]
...
ggsave(filename = "f5f.tiff", plot = combined_plot, width = 7.5, height = 3, units = "in")
...
ggsave(filename = "f5h.tiff", plot = f5h,width = 10, height = 4, units = "in")
...
ggsave(filename = "f5i.tiff", plot = f5i, width = 3.8, height = 3.5, units = "in")
...
ggsave(filename = "f5j.tiff", plot = f5j, width = 5.6, height = 3, units = "in")
