...
ggsave(filename = "f4a.png", plot = f4a, width = 6, height = 6, units = "in")
...
ggsave(filename = "f4b.png", plot = combined_plot, width = 5, height = 4, units = "in")
...
ggsave(filename = "f4c.png", plot = f4c, width = 5.1, height = 4.5, units = "in")
...
ggsave(filename = "f4d.png", plot = f4d, width = 7.1, height = 3, units = "in")
...
metadata2<- sce_score@meta.data[,c("R_T_N","M1_score1","M2_score1","Race_TNM")]
...
ggsave(filename = "f4e.png", plot = combined_plot,width = 6.3, height = 2.5, units = "in")
...
ggsave(filename = "f4f.png", plot = f4f, width = 4.5, height = 3.5, units = "in")
...
ggsave(filename = "f4h.png", plot = final_stacked_plot2, width = 6, height = 6.5, units = "in")
...
ggsave(filename = "f4i.png", plot = f4i, width = 10, height = 3.5, units = "in")
