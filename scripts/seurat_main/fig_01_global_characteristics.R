...
ggsave(filename = "f1a.png", plot = f1a, width = 11, height = 3, units = "in")
...
combined_plot
ggsave(filename = "f1b.png", plot = combined_plot, width = 5.5, height = 4, units = "in")
...
ggsave(filename = "f1c.png", plot = f1c, width = 4.5, height = 6, units = "in")
