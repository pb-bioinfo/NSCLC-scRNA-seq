...
ggsave(filename = "s5a.png", plot = s5a, width = 4.5, height = 4, units = "in")
...
ggsave(filename = "s5b.png", plot = s5b, width = 8.2, height = 3.6,units = "in")
...
avgexpT2 <- AggregateExpression(obj_T, return.seurat = T, group.by = 'seurat_clusters')
...
ggsave(filename = "s5c.png", plot = s5c, width = 6.5, height = 9, units = "in")
...
ggsave(filename = "s5d.png", plot = s5d, width = 4.5, height = 3, units = "in")
...
ggsave(filename = "s5e.png", plot = combined_plot, width = 11, height = 5, units = "in")
...
ggsave(filename = "s5f.png", plot =s5f, width = 5.6, height = 3, units = "in")
...
combined_plot <- (s5g1 | s5g2) + 
  ...
  theme(legend.position = "right")
combined_plot
ggsave(filename = "s5g.png", plot = combined_plot, width = 6, height = 4.5, units = "in")
...
ggsave(filename = "s5h.png", plot = s5h, width = 5.6, height = 3, units = "in")
...
s5i <- final_plot
ggsave(filename = "s5i.png", plot = s5i, width = 7, height = 8, units = "in")
...
ggsave(filename = "s5j.png", plot = s5j, width =  7.5, height = 3, units = "in")
...
ggsave(filename = "s5k.png", plot = s5k, width = 7.5, height = 3, units = "in")
...
ggsave(filename = "s5m.png", plot = combined_plot, width = 5.5, height = 3, units = "in")
...
combined_plot <- (s5n1 | s5n2) + 
  ...
  theme(legend.position = "right")
combined_plot
ggsave(filename = "s5n.png", plot = combined_plot, width = 4.5, height = 3, units = "in")
...
ggsave(filename = "s5o.png", plot = s5o, width = 6, height = 3, units = "in")
...
ggsave(filename = "s5q.png", plot = s5q, width = 6.5, height = 3, units = "in")
...
ggsave(filename = "s5s.png", plot = s5s, width = 3.5, height = 3, units = "in")
...
ggsave(filename = "s5t.png", plot = s5t, width = 5.4, height = 3, units = "in")
