...
trajectory_subset_epi <- qread("trajectory_subset_epi.qs")
...
ggsave(filename = "f2a.png", plot = f2a, width = 7, height = 3, units = "in")
...
ggsave(filename = "f2b.png", plot = combined_plot, width = 4.5, height = 4, units = "in")
...
ggsave(filename = "f2c.png", plot = f2c, width = 5.1, height = 6, units = "in")
...
ggsave(filename = "f2d.png", plot = f2d, width = 6.2, height = 3, units = "in")
...
ggsave(filename = "f2f.png", plot = f2f, width = 6.2, height = 3, units = "in")



#####

pt <- table(trajectory_subset_epi@meta.data$State_merged, trajectory_subset_epi@meta.data$R_T_N)
pt <- as.data.frame(pt)




f2h <-  ggplot(pt, aes(x = Var1, y = Freq, fill = Var2)) +
  theme_bw(base_size = 15) +
  geom_col(position = "fill", width = 0.9) +
  xlab("") +
  ylab("Fraction")  +
...
ggsave(filename = "f2h.png", plot = f2h, width = 4, height = 4, units = "in")

####


f2i1 <- DEenrichRPlot(
  trajectory_subset_epi,
  ident.1 = "1",
  balanced = TRUE,
...
f2i1[[2]] <- f2i1[[2]]  + 
  labs(title ="Other States")+
  geom_hline(yintercept = 1.3, linetype = "dashed", color = "yellow",linewidth = 0.85) +theme(
    plot.title  = element_text(size = 14)  
  )+  theme(axis.text.x = element_text(size = 12),axis.title.x  =element_text(size=12))

ggsave(filename = "f2i1.png", plot = f2i1, width =  8, height = 3, units = "in")
...
ggsave(filename = "f2i2.png", plot = f2i2, width =  8, height = 3, units = "in")
...
ggsave(filename = "f2i3.png", plot = f2i3, width =  8, height = 3, units = "in")
