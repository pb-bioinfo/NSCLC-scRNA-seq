...
ggsave(filename = "s4a.png", plot = s4a, width = 4.5, height = 4, units = "in")
...
ggsave(filename = "s4b.png", plot = s4b, width = 7, height = 3.6,units = "in")
...
cluster.averages = AggregateExpression(obj_myeloid, return.seurat = T, group.by = 'RNA_snn_res.1')

Idents(cluster.averages) <- factor(Idents(cluster.averages), levels = my_levels)
...
ggsave(filename = "s4c.png", plot = s4c, width = 6.5, height = 9, units = "in")
...
s4d <- DimPlot(obj_myeloid, reduction = "umap.Myeloid.rpca", label=T, cols = color.liberal,group.by = "stage1_v3",label.size = 4,repel = FALSE) + NoLegend()+
  labs(y = "UMAP_2", x = "UMAP_1")+ggtitle("")
ggsave(filename = "s4d.png", plot = s4d, width = 3.4, height = 3, units = "in")
...
ggsave(filename = "s4e.png", plot = combined_plot, width = 11, height = 5, units = "in")
...
ggsave(filename = "s4f.png", plot = s4f, width = 5.6, height = 3, units = "in")
...
ggsave(filename = "s4g.png", plot = combined_plot, width = 4.3, height = 3, units = "in")
...
ggsave(filename = "s4h.png", plot = s4h, width = 4.5, height = 4, units = "in")
...
ggsave(filename = "s4i.png", plot = s4i, width = 6.2, height = 3, units = "in")
...
ggsave(filename = "s4j.png", plot = s4j, width = 5, height = 4, units = "in")
...
ggsave(filename = "s4j2.png", plot = s4j2, width = 5, height = 4, units = "in")
...
ggsave(filename = "s4l.png", plot = s4l, width = 4.5, height = 3.5, units = "in")
...
ggsave(filename = "s4l2.png", plot = s4l2, width = 4.5, height = 3.5, units = "in")
...
ggsave(filename = "s4m.png", plot = s4m, width = 6.2, height = 3, units = "in")
...
ggsave(filename = "s4n.png", plot = s4n, width = 6.2, height = 3, units = "in")
...
ggsave(filename = "s4o.png", plot = s4o, width = 6.2, height = 3, units = "in")
...
ggsave(filename = "s4p.png", plot = s4p, width = 4, height = 3.5, units = "in")
...
ggsave(filename = "s4q.png", plot = s4q, width = 4, height = 3.5, units = "in")
