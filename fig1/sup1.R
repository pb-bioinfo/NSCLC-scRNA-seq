...
s1b
ggsave(filename = "s1b.tiff", plot = s1b, width = 5, height = 4.5, units = "in")
...
ggsave(filename = "s1c.tiff", plot = s1c, width = 3.9, height = 9,units = "in")
...
ggsave(filename = "s1d.tiff", plot = s1d, width = 5, height = 4.5, units = "in")
...
cluster.averages <- AverageExpression(rds1, return.seurat = T, group.by = 'seurat_clusters')
...
ggsave(filename = "s1e.tiff", plot = s1e, width = 9, height = 12, units = "in")
...
ggsave(filename = "s1f.tiff", plot = combined_plot, width = 14, height = 7.5, units = "in")
