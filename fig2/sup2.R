...
ggsave(filename = "s2a.tiff", plot = s2a, width = 3.5, height = 3, units = "in")
...
ggsave(filename = "s2b.tiff", plot = s2b, width = 7.2, height = 3.6,units = "in")
...
ggsave(filename = "s2c.tiff", plot = s2c, width = 3.5, height = 3, units = "in")
...
ggsave(filename = "s2d.tiff", plot = combined_plot, width = 4.5, height = 4, units = "in")
...
ggsave(filename = "s2e.tiff", plot = s2e, width = 6, height = 6, units = "in")
...
ggsave(filename = "s2g.tiff", plot = combined_plot, width = 9, height = 5, units = "in")
...
ggsave(filename = "s2h.tiff", plot = s2h, width = 4, height = 3.5, units = "in")
...
s2i <- DimPlot(obj_mali, reduction = "umap", label=F, cols = col_vector,group.by = "Sample_ID") +
  labs(y = "UMAP_2", x = "UMAP_1")+ggtitle("")
s2i
ggsave(filename = "s2i.tiff", plot = s2i, width = 8, height = 4.5, units = "in")
...
ggsave(filename = "s2j.tiff", plot = s2j, width = 5.6, height = 3, units = "in")
...
ggsave(filename = "s2k.tiff", plot = s2k, width = 5.6, height = 3, units = "in")
